...
stroke order — in the [Dictionary-and-Kanji](Dictionary-and-Kanji) view.
...
see [Statistics](Statistics). The **⏸ button** in the bottom bar, or its
...
50 known words before it activates. See [Reviews-and-SRS](Reviews-and-SRS)
