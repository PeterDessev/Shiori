...
use eframe::egui;
use jrc_core::WordKey;

use crate::app::JrcGui;

/// Action chosen in the chat word panel.
enum ChatWordAction {
    Learn(jrc_core::WordId),
    Known(jrc_core::WordId),
    Ignore(jrc_core::WordId),
}
